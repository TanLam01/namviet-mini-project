# MINI TICKETBOX - HỆ THỐNG ĐẶT VÉ CONCERT TẢI CAO

Dự án này là bài thi kỹ thuật (Technical Test) xây dựng hệ thống bán vé concert Mini Ticketbox với khả năng chịu tải cao, chống over-selling (bán quá số lượng) và cập nhật trạng thái thời gian thực (Real-time).
...
2. Mở terminal tại thư mục gốc của dự án (`mini-ticketbox`) và chạy lệnh:
   ```bash
...
*Lưu ý: Backend có tích hợp cơ chế tự động kết nối lại (retries) đề phòng trường hợp PostgreSQL khởi động chậm hơn Go.*
